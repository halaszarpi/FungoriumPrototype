...
public class FungusBody {
    ...
    public FungusBody(Mycelium myceliumm) {
    ...
    public void scatterTo(Tecton targetTecton, String sporeName) throws Exception {
        ...
        try {
            ...
            boolean neighbourOrNeighboursNeigbour = currentTecton.isNeighbourOrNeighboursNeigbour(targetTecton);
